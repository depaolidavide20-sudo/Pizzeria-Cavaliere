...
const DESCRIPTION_OVERRIDES_EN = {
  ...
  "Panino, pollo impanato, insalata, pomodoro, cipolle, ketchup e maionese.": "Sandwich, breaded chicken, lettuce, tomato, onions, ketchup and mayonnaise.",
  "Panino di nostra produzione con pollo, peperoni e cipolla alla piastra, insalata, pomodoro, cipolle, ketchup e maionese.": "Our house-made sandwich with griddled chicken, peppers and onion, lettuce, tomato, onions, ketchup and mayonnaise.",
  "Panino, salsiccia, insalata, pomodoro, cipolle, ketchup e maionese.": "Sandwich, sausage, lettuce, tomato, onions, ketchup and mayonnaise.",
  "Panino, burger di nostra produzione, formaggio, insalata, ketchup, maionese e salsa burger.": "Sandwich, our house-made burger, cheese, lettuce, ketchup, mayonnaise and burger sauce.",
  "Panino, doppio burger di nostra produzione, formaggio, insalata, ketchup, maionese e salsa burger.": "Sandwich, double house-made burger, cheese, lettuce, ketchup, mayonnaise and burger sauce.",
  "Hamburger o piadina, bibita e patatine.": "Burger or wrap, drink and fries.",
  "Bottiglia da 50 cl.": "50 cl bottle.",
  "Bottiglia da 1,5 L.": "1.5 L bottle.",
...
const DESCRIPTION_TERMS_EN = [
  ...
  ["salsa burger", "burger sauce"], ["yogurt piccante", "spicy yogurt sauce"],
...
const MENU_ITEMS = [
  ...
  { id: "pizza-kebab", name: "Pizza kebab", category: "pizze", description: "Pomodoro fresco, mozzarella, kebab, insalata, cipolla, patatine, ketchup, maionese e yogurt piccante.", prices: twoSizes(9, 13) },
  ...
  { id: "bocconcini-pollo", name: "Bocconcini di pollo", category: "cucina", description: "Bocconcini di pollo dorati.", prices: onePrice(3.5) },
  { id: "patatine", name: "Patatine fritte", category: "cucina", description: "Patatine fritte croccanti.", prices: [{ label: "Mini", price: 3 }, { label: "Normale", price: 4 }] },

  { id: "panino-chicken", name: "Panino chicken", category: "panini", description: "Panino, pollo impanato, insalata, pomodoro, cipolle, ketchup e maionese.", prices: onePrice(5) },
  { id: "panino-fajita", name: "Panino fajita", category: "panini", description: "Panino di nostra produzione con pollo, peperoni e cipolla alla piastra, insalata, pomodoro, cipolle, ketchup e maionese.", prices: onePrice(7) },
  { id: "panino-salsiccia", name: "Panino con salsiccia", category: "panini", description: "Panino, salsiccia, insalata, pomodoro, cipolle, ketchup e maionese.", prices: onePrice(6.5) },
  { id: "cheeseburger", name: "Cheeseburger", category: "panini", description: "Panino, burger di nostra produzione, formaggio, insalata, ketchup, maionese e salsa burger.", prices: onePrice(6) },
  { id: "doppio-cheeseburger", name: "Doppio cheeseburger", category: "panini", description: "Panino, doppio burger di nostra produzione, formaggio, insalata, ketchup, maionese e salsa burger.", prices: onePrice(8) },
  { id: "menu-cavaliere", name: "Menù del Cavaliere", category: "panini", description: "Hamburger o piadina, bibita e patatine.", prices: onePrice(10) },

  { id: "panino-kebab", name: "Panino kebab", category: "kebab", description: "Carne kebab, insalata, pomodoro, cipolla, patate, ketchup, maionese e yogurt piccante.", prices: onePrice(6.5) },
  { id: "piadina-kebab", name: "Piadina kebab", category: "kebab", description: "Carne kebab, insalata, pomodoro, cipolla, patate, ketchup, maionese e yogurt piccante.", prices: onePrice(6) },
  { id: "falafel", name: "Falafel di ceci", category: "kebab", description: "Falafel, insalata, pomodoro, cipolla, patate, ketchup, maionese e yogurt piccante.", prices: onePrice(6) },
  { id: "piatto-kebab", name: "Piatto kebab", category: "kebab", description: "Carne kebab, insalata, pomodoro, cipolla, patate, ketchup, maionese e yogurt piccante.", prices: onePrice(7) },

  { id: "acqua-50", name: "Acqua naturale o frizzante", category: "bevande", description: "Bottiglia da 50 cl.", prices: onePrice(1.5) },
  { id: "acqua-grande", name: "Acqua naturale o frizzante", category: "bevande", description: "Bottiglia da 1,5 L.", prices: onePrice(2.5) },
